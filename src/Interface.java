...
public class Interface {
	...
	public void playGame() {
		...
		while (players.size() > 1 && turns <= 1000) {
			...
			System.out.println("========================================");
			displayPlayerInfo(currPlayer);
			
			// Display turn menu
			showTurnMenu(currPlayer);
			
			// Execute turn
			playTurn(currPlayer, 0);
			
			System.out.println("\nEnd of turn balance: $" + currPlayer.getMoneyAmount());
	...
	private void showTurnMenu(Player player) {
		...
		switch (choice) {
			...
			case 3:
				...
				break;
			case 4:
				System.out.println("\nProceeding with turn...");
				break;
			default:
				System.out.println("\nInvalid choice. Proceeding with turn...");
				break;
		}
	}
